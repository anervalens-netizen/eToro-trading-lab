...
GRANT CONNECT ON DATABASE etoro_v2 TO
  "etoro-candidate", "etoro-ai", "etoro-decision", "etoro-exit",
...
REVOKE ALL ON ALL TABLES IN SCHEMA public FROM
  "etoro-engine", "etoro-candidate", "etoro-ai", "etoro-decision",
...
TO "etoro-candidate";
GRANT INSERT,UPDATE ON v2_meta,v2_service_heartbeats TO "etoro-candidate";
GRANT SELECT,INSERT ON v2_ai_packets,v2_events TO "etoro-candidate";
...
GRANT INSERT,UPDATE ON v2_meta,v2_service_heartbeats,v2_ai_packets TO "etoro-ai";
GRANT INSERT ON v2_ai_runs,v2_ai_budget_claims,v2_events TO "etoro-ai";
...
GRANT SELECT ON v2_meta,v2_schema_migrations,v2_trading_state,v2_intents,
  ...
  v2_ai_packets TO "etoro-decision";
GRANT INSERT,UPDATE ON v2_meta,v2_trading_state,v2_intents,v2_decisions,
  v2_order_commands,v2_broker_orders,v2_risk_reservations,v2_positions,
  v2_reconciliation_cases,v2_outbox,v2_service_heartbeats,v2_ai_packets
TO "etoro-decision";
GRANT INSERT ON v2_events TO "etoro-decision";
...
GRANT INSERT,UPDATE ON v2_meta,v2_trading_state,v2_decisions,v2_order_commands,
  v2_broker_orders,v2_risk_reservations,v2_positions,v2_reconciliation_cases,
  v2_outbox,v2_service_heartbeats TO "etoro-exit";
...
GRANT INSERT,UPDATE ON v2_meta,v2_trading_state,v2_decisions,v2_order_commands,
  v2_broker_orders,v2_risk_reservations,v2_positions,v2_reconciliation_cases,
  v2_outbox,v2_pnl_daily,v2_service_heartbeats TO "etoro-reconciler";
...
GRANT UPDATE ON v2_trading_state,v2_broker_orders,v2_risk_reservations,v2_outbox
TO "etoro-control";
...
GRANT UPDATE ON v2_trading_state,v2_broker_orders,v2_risk_reservations,v2_outbox
TO "etoro-executor";
GRANT INSERT,UPDATE ON v2_positions,v2_reconciliation_cases,v2_service_heartbeats
TO "etoro-executor";
...
FROM "etoro-engine", "etoro-candidate", "etoro-ai", "etoro-decision",
  "etoro-exit", "etoro-reconciler", "etoro-control", "etoro-executor",
  "etoro-observer", "etoro-collector";
