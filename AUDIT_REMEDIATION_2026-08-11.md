# Final audit remediation — v0.5.1
...
- Repository version is 0.5.1, with changelog, explicit all-rights-reserved license, one canonical v2 runtime ADR, separate private-key recovery procedure and an installed-wheel schema/resource gate.
