# Final audit remediation — v0.5.2
...
- Repository version is 0.5.2, with changelog, explicit all-rights-reserved license, one canonical v2 runtime ADR, separate private-key recovery procedure, installed-wheel schema/resource gate and populated-database migration regression coverage.
