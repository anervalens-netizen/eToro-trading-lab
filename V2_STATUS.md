...
- PostgreSQL schema version is 6 and package version is 0.5.8; restore drills derive their expected schema from the installed runtime rather than a fixed literal.
