    ...
    def test_open_compatibility_interface_uses_current_create_order(self) -> None:
        ...
        def fake_request(method, path, **kwargs):
            ...
            if path == DEMO_ELIGIBILITY:
                return ApiResponse(200,{"eligibilities":[{"allowOpenPosition":True,"minPositionExposure":10,"leverageConfigs":[{"direction":"long","leverageValues":[1],"allowStopLossTakeProfit":True,"minPositionAmount":10,"settlementType":"real","minStopLossPercentage":1,"maxStopLossPercentage":50,"minTakeProfitPercentage":1,"maxTakeProfitPercentage":100}]}]},"00000000-0000-0000-0000-000000000000")
            if path.endswith("/rates"):
                return ApiResponse(200,{"rates":[{"instrumentID":1001,"bid":99,"ask":100}]},"00000000-0000-0000-0000-000000000000")
            return ApiResponse(200,{},kwargs.get("request_id") or "00000000-0000-0000-0000-000000000000")
