...
| T10 | Close the passive remote-digest shell expansion and repeat exact release/runtime/Dell proof | T9 | primary + independent auditor | 1 | VERIFYING |
...
Verify and independently audit the fixed passive digest command, then publish/deploy one exact v0.6.8 artifact and repeat primary/Dell proof.
